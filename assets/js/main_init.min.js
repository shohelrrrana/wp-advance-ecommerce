window.theme = {}, window.theme.fn = {
    ...
    n.defaults = {
        ...
        initialize: function (t, s) {
            ...
            return this.options = s.extend(!0, {}, n.defaults, t, {wrapper: this.$el}), this
        }, build: function () {
            if (!s.isFunction(s.fn.countTo)) return this;
            var t = this, n = this.options.wrapper, e = t.options.numberClass ? " " + t.options.numberClass : "",
    ...
    }, s.extend(t, {PluginCountdown: n}), s.fn.themePluginCountdown = function (t) {
