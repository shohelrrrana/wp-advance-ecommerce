!function () {
    ...
    var e = 0, i = {}, o = window.Waypoint, s = window.onload;
    t.prototype.add = function (t) {
        ...
        for (var i in e) {
            var o = e[i], s = o.newScroll > o.oldScroll ? o.forward : o.backward;
            for (var n in this.waypoints[i]) {
                var r = this.waypoints[i][n];
                if (null !== r.triggerPoint) {
                    var a = o.oldScroll < r.triggerPoint, h = o.newScroll >= r.triggerPoint;
        ...
        for (var n in t) {
            ...
            for (var a in this.waypoints[n]) {
                var h, l, p, c, d, u = this.waypoints[n][a], m = u.options.offset, f = u.triggerPoint, g = 0,
                    w = null == f;
    ...
    var o = {vertical: {}, horizontal: {}}, s = window.Waypoint;
    i.prototype.add = function (t) {
        ...
        for (var i in this.triggerQueues) {
            var o = this.triggerQueues[i], s = "up" === i || "left" === i;
            o.sort(s ? e : t);
    ...
    t.fn.TouchSpin = function (i) {
        ...
        return this.each(function () {
            ...
            var u, m, f, g, w, v, y, z, x, b, _ = t(this), C = _.data(), T = 0, W = !1;
            !function () {
                if (!_.data("alreadyinitialized")) {
                    ...
                    }), a), i)).initval && "" === _.val() && _.val(u.initval), r(), function () {
                        var e = _.val(), i = _.parent();
    ...
    e.DEFAULTS = {
        ...
        return this.each(function () {
            var o = t(this), s = o.data("countTo"), n = "object" == typeof i ? i : {},
    ...
    var e, i, o, s, n, r, a = "Close", h = "BeforeClose", l = "MarkupParse", p = "Open", c = "Change", d = "mfp",
        u = "." + d, m = "mfp-ready", f = "mfp-removing", g = "mfp-prevent-close", w = function () {
        }, v = !!window.jQuery, y = t(window), z = function (t, i) {
            e.ev.on(d + t + u, i)
        }, x = function (e, i, o, s) {
    ...
    w.prototype = {
        constructor: w, init: function () {
            ...
            if (s.tagName ? s = {el: t(s)} : (o = s.type, s = {data: s, src: s.src}), s.el) {
                for (var n = e.types, r = 0; r < n.length; r++) if (s.el.hasClass("mfp-" + n[r])) {
                    o = n[r];
                    break
                }
            ...
            if (!t(i).hasClass(g)) {
                var o = e.st.closeOnContentClick, s = e.st.closeOnBgClick;
                if (o && s) return !0;
        ...
        if ("string" == typeof i) if ("open" === i) {
            var s, n = v ? o.data("magnificPopup") : o[0].magnificPopup, r = parseInt(arguments[1], 10) || 0;
            n.items ? s = n.items[r] : (s = o, n.delegate && (s = s.find(n.delegate)), s = s.eq(r)), e._openClick({mfpEl: s}, o, n)
        } else e.isOpen && e[i].apply(e, Array.prototype.slice.call(arguments, 1)); else i = t.extend(!0, {}, i), v ? o.data("magnificPopup", i) : o[0].magnificPopup = i, e.addGroup(o, i);
        return o
    };
    var T, W, S, k = "inline", L = function () {
    ...
    t.magnificPopup.registerModule("image", {
        options: {
            ...
            initImage: function () {
                ...
                var i = 0, o = t.img[0], s = function (n) {
        ...
        options: {
            ...
            initZoom: function () {
                ...
                if (i.enabled && e.supportsTransition) {
                    var s, n, r = i.duration, l = function (t) {
    ...
    t.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                ...
                var t, i = e.st.gallery.preload, o = Math.min(i[0], e.items.length), s = Math.min(i[1], e.items.length);
    ...
    s.Defaults = {
        ...
        filter: ["width", "items", "settings"], run: function (t) {
            var e = (this.width() / this.settings.items).toFixed(3) - this.settings.margin, i = null,
                o = this._items.length, s = !this.settings.autoWidth, n = [];
            for (t.items = {
                merge: !1,
                width: e
        ...
        filter: ["items", "settings"], run: function () {
            var e = [], i = this._items, o = this.settings, s = Math.max(2 * o.items, 4),
                n = 2 * Math.ceil(i.length / 2), r = o.loop && i.length ? o.rewind ? s : Math.max(s, n) : 0, a = "",
                h = "";
        ...
        filter: ["width", "position", "items", "settings"], run: function () {
            var t, e, i, o, s = this.settings.rtl ? 1 : -1, n = 2 * this.settings.stagePadding,
                r = this.coordinates(this.current()) + n, a = r + this.width() * s, h = [];
        ...
        var e = null, i = null, o = null, s = this.difference(this._drag.pointer, this.pointer(t)),
        ...
        var o = this.difference(this._drag.pointer, this.pointer(e)), s = this._drag.stage.current,
        ...
        var i = this.current(), o = null, s = t - this.relative(i), n = (s > 0) - (s < 0), r = this._items.length,
        ...
        this._core = e, this._loaded = [], this._handlers = {
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": t.proxy(function (e) {
                if (e.namespace && this._core.settings && this._core.settings.lazyLoad && (e.property && "position" == e.property.name || "initialized" == e.type)) {
                    var i = this._core.settings, o = i.center && Math.ceil(i.items / 2) || i.items,
                        s = i.center && -1 * o || 0,
    ...
    s.Defaults = {autoHeight: !1, autoHeightClass: "owl-height"}, s.prototype.update = function () {
        var e = this._core._current, i = e + this._core.settings.items, o = this._core.settings.lazyLoad,
            s = this._core.$stage.children().toArray().slice(e, i), n = [], r = 0;
    ...
    s.Defaults = {video: !1, videoHeight: !1, videoWidth: !1}, s.prototype.fetch = function (t, e) {
        ...
        var o, s, n, r = i.width && i.height ? "width:" + i.width + "px;height:" + i.height + "px;" : "",
            a = e.find("img"), h = "src", l = "", p = this._core.settings, c = function (i) {
        ...
        var i, o = t(e.target).closest("." + this._core.settings.itemClass), s = this._videos[o.attr("data-video")],
            n = s.width || "100%", r = s.height || this._core.$stage.height();
    ...
    s.Defaults = {
        ...
        var t, e, i = this._core.clones().length / 2, o = i + this._core.items().length, s = this._core.maximum(!0),
            n = this._core.settings, r = n.center || n.autoWidth || n.dotsData ? 1 : n.dotsEach || n.items;
        if ("page" !== n.slideBy && (n.slideBy = Math.min(n.slideBy, n.items)), n.dots || "page" == n.slideBy) for (this._pages = [], t = i, e = 0, 0; t < o; t++) {
            if (e >= r || 0 === e) {
        ...
        var e, i = this._core.settings, o = this._core.items().length <= i.items,
            s = this._core.relative(this._core.current()), n = i.loop || i.rewind;
    ...
    t.prototype.createWaypoint = function () {
        ...
        this.waypoint = new i(e.extend({}, this.options, {
            element: this.wrapper, handler: e.proxy(function (e) {
                var i = this.options.direction.indexOf(e) > -1, o = i ? this.$element.outerHeight(!0) : "";
    ...
    var i = function () {
        var i = {
        ...
        }(), n = !!e.PointerEvent, r = function (t, e, o) {
            var s = i.menuClass;
            ...
            var i = t(this), o = p(i), s = i.siblings(e.data.popUpSelector);
        ...
        return {
            hide: function (e) {
                ...
                return this.each(function () {
                    var e, o = t(this), s = o.data("sfOptions");
                ...
                return this.each(function () {
                    ...
                    var s = t.extend({}, t.fn.superfish.defaults, e), n = o.find(s.popUpSelector).parent("li");
                    s.$path = function (e, o) {
        ...
        init: function (e, i) {
            ...
            if (s.onload = function () {
                ...
                if (o.$elem.attr("src", e), o.$elem.after(r), r.stop(!0).fadeOut(o.options.imageCrossfade, function () {
                    ...
                    var a = o.zoomTintImage, h = a.clone();
                    o.zoomTintImage.attr("src", i), o.zoomTintImage.after(h), h.stop(!0).fadeOut(o.options.imageCrossfade, function () {
                        t(this).remove()
                    }), a.fadeIn(o.options.imageCrossfade), o.zoomTint.css({height: o.$elem.height()}), o.zoomTint.css({width: o.$elem.width()})
                }
    ...
    e.fn.themePin = function (t) {
        var i = 0, o = 0, s = [], n = !1, r = e(window), a = [], h = [];
        t = t || {};
        var l = function () {
            for (var i = 0, o = s.length; i < o; i++) {
                ...
                if (t.minWidth && r.width() <= t.minWidth) a.parent().is(".pin-wrapper") && a.unwrap(), a.css({
                    ...
                    top: "",
                    position: ""
                }), t.activeClass && a.removeClass(t.activeClass), a.removeClass("sticky-transition"), a.removeClass("sticky-absolute"), n = !0; else {
                    n = !1;
                    ...
                    if (void 0 !== p) {
                        ...
                        var f = a.css("border-bottom"), g = a.outerHeight();
                        a.css("border-bottom", "1px solid transparent");
                        var w = a.outerHeight() - g - 1;
                        a.css("border-bottom", f), a.css({width: a.outerWidth() <= a.parent().width() ? a.outerWidth() : a.parent().width()}), a.parent().css("height", a.outerHeight() + w), !t.autoFit && !t.fitToBottom || a.outerHeight() <= r.height() ? a.data("themePin", {
                            pad: d,
            ...
            if (!n) {
                ...
                for (var l = window.innerHeight || r.height(), p = 0, c = s.length; p < c; p++) {
                    var d, u = e(s[p]), m = u.data("themePin"), f = m.to;
                    if (m) {
        ...
        return this.each(function () {
            var t = e(this), i = e(this).data("themePin") || {};
    ...
    }, e.extend(t, {Sticky: i}), e.fn.themeSticky = function (i) {
